...
try:
    print("ai/main.py: from ai.~ import * 로 시도합니다.")
    from ai.train import *
except Exception as e:
    print(e)
    print("main.py: from train import * 로 시도합니다.")
    from train import *

## Parser 생성하기
def get_parser():
    """Argument Parser를 생성하여 반환하는 함수"""
    parser = argparse.ArgumentParser(
        description="Regression Tasks such as inpainting, denoising, and super_resolution",
